...
const SymbolicDisarray = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      <AppContainer title="Symbolic Disarray">
        <Visualization
          {...{
            classes,
            debugMode,
            ...
            <ListItem>
              <Button
                ...
                onClick={() => {
                  dispatch(
                    ACTION_CREATORS.setvisParams({
                      points: createVisData(numberOfColumns, numberOfRows),
                    }),
                  );
                }}
              >
